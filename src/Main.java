...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        new Thread(() -> {
            ...
            System.out.println("“екст с максимальным количеством букв a (" + maxTextABC.getCount() + "):\n" + maxTextABC.getText() + "\n");
        }).start();
        ...
        new Thread(() -> {
            ...
            System.out.println("“екст с максимальным количеством букв b (" + maxTextABC.getCount() + "):\n" + maxTextABC.getText() + "\n");
        }).start();
        ...
        new Thread(() -> {
            ...
            System.out.println("“екст с максимальным количеством букв c (" + maxTextABC.getCount() + "):\n" + maxTextABC.getText() + "\n");
        }).start();
    }
